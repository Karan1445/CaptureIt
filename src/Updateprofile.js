...
export default function Update(){
    ...
    useEffect(()=>{
        fetch("http://localhost:8080/login/"+localStorage.getItem("contactNumber")).then((res)=>res.json()).then((newdata)=>SetData(newdata[0]))
        ...
        <form onSubmit={(e)=>submits(e)}>
          <div className="row ">
            <div className="col">
                ...
                <div className="col d-flex justify-content-center">
                  <input  required type="text" name='userName'  defaultValue={localStorage.getItem("userName")} onChange={(e)=>getData(e)} />
                  </div>
                  </div>
                ...
                <div className="col d-flex justify-content-center">
                  <input  required type="text" name='passWord' defaultValue={localStorage.getItem("passWord")} onChange={(e)=>getData(e)}/>
                  </div>
                  </div>
                ...
                <div className="col d-flex justify-content-center">
                  <input required  type="email" name='emailAddress' defaultValue={localStorage.getItem("emailAddress")}  onChange={(e)=>getData(e)}/>
                  </div>
                  </div>
                ...
                <div className="col d-flex justify-content-center">
                  <input  required type="text" name='city' defaultValue={localStorage.getItem("city")} onChange={(e)=>getData(e)}/>
                  </div>
                  </div>
